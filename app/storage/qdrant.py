...
class Qdrant:
    ...
    def __init__(self, use_openai_embeddings=True, batch_size=32):
        ...
        try:
            ...
            print(f"qdrant connected to {qdrant_url} (REST API)")
        except:
    ...
    def init_pdf_collection(self, collection_name):
        # Initialize collection for PDF documents
        try:
            self.client.get_collection(collection_name)
        except:
            logger.info(f"creating PDF collection {collection_name}")
            ...
            print(f"PDF Collection '{collection_name}' CREATED.")

    def add_pdf_document(self, collection_name, chunks, metadata=None):
        # Add PDF document chunks to collection
        self.init_pdf_collection(collection_name)
        meta = metadata or {}
    ...
    def query_pdf_documents(self, collection_name, query, top_k=10, pdf_ids=None):
        # Query PDF documents with optional PDF ID filtering
