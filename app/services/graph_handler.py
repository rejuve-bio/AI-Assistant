...
from helpers import schema_description, sample_json_format
...
class Annotation_service_GraphHandler(QueryHandler):
    ...
    def query_and_refactoring_json_format(self):
        # add id to the json format
        # send query to the anotation
        # if there is schema issue do this all over again or what?
        # self.parsed_json
        # call query_annotation_service
        self.graph = {"nodes":[
  {
            "data": {
                "id": "enst00000378392",
